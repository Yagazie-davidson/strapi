...
export default function Home() {
	return (
		<div>
			<div className="bg-[#181826] bg-[url('/strapi5_hero.svg')] bg-no-repeat bg-cover bg-center md:px-[112px] py-3 h-screen flex justify-center items-center">
				<div className="md:px-28">
					<div className="flex items-center justify-center mb-10">
						<div className="bg-[#212134] w-fit flex items-center space-x-6  py-1.5 px-3 justify-center rounded-[8px] border-[0.5px] border-[#32324d]">
							<div className="bg-[#9739de] text-white font-bold text-[14px] px-1 rounded-[4px]">
								Soon
							</div>
							<div className="text-white text-[14px] font-bold">
								StrapiConf Keynote kicks off on May 13, 10AM CEST.
							</div>
							<div className="text-[#9739de] cursor-pointer flex items-center text-[14px] space-x-1">
								<p>Watch here</p>
								<MoveRight size={15} />
							</div>
						</div>
					...
					<p className="text-white text-[17px] font-normal text-center mt-10">
			...
			<div className="bg-white h-screen flex justify-center items-center md:px-[112px]">
				<div className="">
					...
					<h3 className="text-[33px] md:text-[53px] font-bold text-center text-[#292875] md:px-[100px]">
						Building your website the way you want is hard
					</h3>
					<p className="text-[17px] font-medium text-center mt-5 text-[#666687]">
